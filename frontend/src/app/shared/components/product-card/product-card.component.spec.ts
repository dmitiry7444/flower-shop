...
describe('product-card component', () => {
  ...
  beforeEach(() => {
    ...
    const favoriteServiceSpy = jasmine.createSpyObj('FavoriteService', ['addFavourite', 'removeFavourite']);
  ...
  it('should hide product-card-info and product-card-extra if it if light card', (done: DoneFn) => {
